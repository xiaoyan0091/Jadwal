...
from .telegraph_handler import update_telegraph, create_telegraph_account
from .utils import (
    get_today,
...
async def panel_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await panel_refresh(update, context)
...
async def handle_callbacks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "set_media":
        ...
        await panel_refresh(query, context, is_callback=True)
...
async def panel_refresh(update_or_query, context, is_callback=False):
